...
ds_bry['dye_north_02'] = dye_time_north
ds_bry['dye_north_02'].attrs['long_name'] = 'Passive tracer dye northern boundary conditions'
ds_bry['dye_north_02'].attrs['units'] = 'kg m-3' 
...
ds_bry['dye_south_02'] = dye_time_south
ds_bry['dye_south_02'].attrs['long_name'] = 'Passive tracer dye southern boundary conditions'
ds_bry['dye_south_02'].attrs['units'] = 'kg m-3' 
...
ds_bry['dye_east_02'] = dye_time_east
ds_bry['dye_east_02'].attrs['long_name'] = 'Passive tracer dye eastern boundary conditions'
ds_bry['dye_east_02'].attrs['units'] = 'kg m-3' 
...
ds_bry['dye_west_02'] = dye_time_west
ds_bry['dye_west_02'].attrs['long_name'] = 'Passive tracer dye western boundary conditions'
ds_bry['dye_west_02'].attrs['units'] = 'kg m-3' 
...
ds_clm['dye_02'] = dye_time
ds_clm['dye_02'].attrs['long_name'] = 'Passive tracer dye concentration'
ds_clm['dye_02'].attrs['units'] = 'kg m-3' 
...
ds_ini.to_netcdf(path='../../LO_output/forcing/cas7/f2012.10.07/ocnG00dye2/ocean_ini.nc')
ds_bry.to_netcdf(path='../../LO_output/forcing/cas7/f2012.10.07/ocnG00dye2/ocean_bry.nc')
ds_clm.to_netcdf(path='../../LO_output/forcing/cas7/f2012.10.07/ocnG00dye2/ocean_clm.nc')
