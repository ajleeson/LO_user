"""
A Leeson copied from LO/extract/tef2 on 2025.04.22 and modified
to process Eulerian daily averages from the hourly data.
--------------------------------------------------------------
...
To run:
run process_sections.py -gtx cas7_t0_x4b -ctag c21 -0 2017.01.01 -1 2017.12.31
