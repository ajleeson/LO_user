...
def get_box(job, Lon, Lat):
    ...
    if job == 'sequim0':
        ...
        aa = [-123.2, -122.1, 46.95, 48.45]
        vn_list = 'h,pm,pn,mask_rho,salt,temp,oxygen'#'h,pm,pn,mask_rho,salt,temp,zeta,NO3,NH4,phytoplankton,zooplankton,detritus,Ldetritus,oxygen,TIC,alkalinity,rho'
