...
Then creates triv_info.csv and wwtp_info.csv with points rouce indices and 
river direction.
        ...
        if source_type == 'riv':
            ...
            for i,rn in enumerate(rowcol_df.index):
                ...
                if uv == 'u' and isign == 1:
                    ...
                    # add river name
                    ax.text(lon[jj,ii+1], lat[jj,ii+1]+0.003, rn, color = 'purple', fontsize=12, horizontalalignment='center')
                    # plot tracks
                    ...
                    # add river name
                    ax.text(lon[jj,ii], lat[jj,ii]+0.003, rn, color = 'purple', fontsize=12, horizontalalignment='center')
                    # plot tracks
                    ...
                    # add river name
                    ax.text(lon[jj+1,ii], lat[jj+1,ii]+0.003, rn, color = 'purple', fontsize=12, horizontalalignment='center')
                    # plot tracks
...
#################################################################################
        ...
        if source_type == 'wwtp':
            ...
            for ii,source in enumerate(snames):
                ...
                ax.text(text_lon, text_lat, source, color = 'purple', fontsize=12, horizontalalignment='center')
