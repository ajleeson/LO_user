"""
Code to plot extract moor information from cas6_traps01_uu0mb,
the second LiveOcean run with TRAPS and no WWTP at Birch Bay
"""
...
grid_nc = '../../LO_output/extract/cas6_traps01_uu0mb/moor/birchbay_wwtp/wwtp_2020.01.01_2020.01.01.nc'
...
# title
fig.suptitle('Moor Extraction Velocities at Loc of Birch Bay WWTP (No WWTP)', fontsize = ts)
plt.show()

# Other variables -------------------------------------------------------------------------------
fig, ax = plt.subplots(3,2,figsize = (15,8), sharex = True, sharey = True)
fig.suptitle('Moor Extraction State Variables at Loc of Birch Bay WWTP (No WWTP)', fontsize = ts)
...
ax[1,1].axvline(20.5,-15,5, color='k', linestyle=':')
