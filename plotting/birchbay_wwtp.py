...
grid_nc = '../../LO_output/extract/cas6_traps00_uu0mb/moor/birchbay_wwtp/wwtp_2020.01.01_2020.01.01.nc'
...
# title
fig.suptitle('CFL Number at Birch Bay WWTP (2020.01.01)', fontsize = ts)
plt.show()
