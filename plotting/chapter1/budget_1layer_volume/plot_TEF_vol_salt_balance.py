...
salt_p = tef_df['salt_p'] # 
salt_m = tef_df['salt_m'] # 
Q_p = tef_df['q_p'] # Qout
Q_m = tef_df['q_m'] # Qin
sf_p = salt_p * Q_p # salt flux
sf_m = salt_m * Q_m
...
riv_list = seg_df['lynchcove_p']['riv_list']
...
# all TRAPS names in lynchcove inlet


# fn_riv = './data/extraction_2016.01.01_2018.12.31.nc'
fn_riv = Ldir['LOo'] / 'extract' / 'tef2' / 'extractions_2014.01.01_2014.12.31.nc'
