...
in_dir0 = Path('/data1/auroral/LO_roms')

in_fn = in_dir0 / 'alpe2_npzd0_bpart' / 'f2020.02.28' / 'ocean_his_0025.nc'

out_dir = Ldir['roms_out'] / 'alpe2_npzd0withnutr_bpart' / 'f2020.02.28'
