...
run make_forcing_main.py -g hc_al -r backfill -d 2020.01.01 -f ocn_hc -test True
...
# # get lat for cutoff
# # Note: I just test printed the lat until I got the index that was just below lat = 48
# lat = G['lat_rho'][:,0]
# print(lat[222])
...
# Add horizontal, linear gradient in salt at the first timestep.
# Note: estuary mouth is at a latitude of 48.
# NT = 0, NZ = :, NC = :, NR = varies....
